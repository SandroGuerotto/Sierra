...
public class ApplicationHandler implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        pane_container.add(new Menubanner(pane_container, pane_main, null), 0, 0, 4, 1);
        ...
        Platform.runLater(() -> {
            System.out.println(pane_main.getWidth() + " afsdf" + pane_main.getHeight());
            System.out.println(pane_container.getWidth() + " afsdf" + pane_container.getHeight());
                });
